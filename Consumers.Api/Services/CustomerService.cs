...
public class CustomerService : ICustomerService
{
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _sqsMessanger.SendMessageAsync(customer.ToCustormerCreatedMessage());
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _sqsMessanger.SendMessageAsync(customer.ToCustomerUpdatedMessage());
        }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if (response)
        {
            await _sqsMessanger.SendMessageAsync(new CustomerDeleted
            {
                Id = id
            });
        }
